...
REAL,DIMENSION(:), SAVE, POINTER :: XLBC ! Cloud droplet distribution parameters
...
!
REAL,DIMENSION(:),SAVE,POINTER :: XRTMIN ! Min values allowed for the mixing ratios
REAL,DIMENSION(:,:,:), SAVE, POINTER :: XCONC ! Concentration of cloud droplet
